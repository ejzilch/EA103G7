...
<body>
	...
	<div class="wrapper">
		...
		<ul>
			<li><a
				href='<%=request.getContextPath()%>/back-end/news/listAllnews.jsp'>全部查詢</a>
				all News. <br> <br></li>

			<li>
				<FORM METHOD="post"
					ACTION="<%=request.getContextPath()%>/news/news.do">
					<b>消息編號(NEWS0001):</b> <input type="text" name="news_no">
			...
			<li>
				<FORM METHOD="post"
					ACTION="<%=request.getContextPath()%>/news/news.do">
					<b>消息編號:</b> <select size="1" name="news_no">
			...
			<li>
				<FORM METHOD="post"
					ACTION="<%=request.getContextPath()%>/news/news.do">
					<b>選擇員工編號:</b> <select size="1" name="news_no">
						<c:forEach var="newsVO" items="${newsSvc.all}">
							<option value="${newsVO.news_no}">${newsVO.emp_no}
						</c:forEach>
					</select> <input type="hidden" name="action" value="getOne_For_Display">
		...
		<ul>
			<li><a
				href='<%=request.getContextPath()%>/back-end/news/addNews.jsp'>新增</a>
				a new News.</li>
		</ul>
</body>
