...
%>
<%-- <%= member_reviewVO==null%> --%>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<title>紅利商品新增 - addBonus.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>紅利商品新增 - addBonus.jsp</h3></td><td>
...
<table>
	<tr>
		...
		<td><input type="TEXT" name="bns_name" size="45" 
			 value="<%= (bonusVO==null)? "請輸入紅利商品名稱" : bonusVO.getBns_name()%>" /></td>
	</tr>
	<tr>
		<td>紅利商品價格:</td>
		<td><input type="TEXT" name="bns_price" size="45"
			 value="<%= (bonusVO==null)? "請輸入紅利商品價格" : bonusVO.getBns_price()%>" /></td>
	</tr>
	<tr>
		<td>庫存量:</td>
		<td><input type="TEXT" name="bns_stks" size="45"
			 value="<%= (bonusVO==null)? "請輸入庫存量" : bonusVO.getBns_stks()%>" /></td>
	</tr>
	<tr>
		<td>有效日期:</td>
	...
	<tr>
		<td>紅利商品狀態:</td>
		<td><input type="TEXT" name="bns_sts" size="45"
			 value="<%= (bonusVO==null)? "請輸入紅利商品狀態" : bonusVO.getBns_sts()%>" /></td>
	</tr>
	<tr>
		<td>紅利商品圖片:</td>
