...
public class Member_ReviewDAO implements Member_ReviewDAO_interface {
	...
	static {
		...
		private static final String INSERT_STMT = 
			"INSERT INTO member_review (review_no,meal_order_no,mem_review_con,review_date) VALUES ('MR'||LPAD(SEQ_REVIEW_NO.NEXTVAL,4,0), ?, ?, ?)";
		...
		private static final String UPDATE = 
			"UPDATE member_review set meal_order_no=?, mem_review_con=?, review_date=? where review_no = ?";
