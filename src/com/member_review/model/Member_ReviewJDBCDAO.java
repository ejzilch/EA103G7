...
public class Member_ReviewJDBCDAO implements Member_ReviewDAO_interface {
	...
	String passwd = "123456";
		...
		private static final String INSERT_STMT =
			"INSERT INTO member_review (review_no,meal_order_no,mem_review_con,review_date,review_sts,review_del) VALUES ('MR'||LPAD(SEQ_REVIEW_NO.NEXTVAL,4,0), ?, ?, ?, ?, ? )";
		private static final String GET_ALL_STMT =
			"SELECT review_no,meal_order_no,mem_review_con,to_char(review_date,'yyyy-mm-dd') review_date, review_sts,review_del FROM member_review order by review_no";
		private static final String GET_ONE_STMT =
			"SELECT review_no,meal_order_no,mem_review_con,to_char(review_date,'yyyy-mm-dd') review_date, review_sts,review_del FROM member_review where review_no = ?";
		private static final String DELETE =
			"DELETE FROM member_review where review_no = ?";
		private static final String UPDATE =
			"UPDATE member_review set meal_order_no=?, mem_review_con=?, review_date=?, review_sts=?, review_del=? where review_no = ?";
